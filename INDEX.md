...
Master list of all artifacts in this library. Update whenever an artifact is
added, renamed, or its status/version changes.

| ID | Title | Type | ADM Phase | Status | Owner | Version | Path |
|----|-------|------|-----------|--------|-------|---------|------|
| PRIN-CAT-01 | Architecture Principles Catalog | catalog | Preliminary | approved | Chief Architect | 1.0 | `00-preliminary/architecture-principles-catalog.md` |
| VISION-01 | Architecture Vision - Unified Commerce Platform | vision | Architecture Vision | approved | Chief Architect | 1.0 | `01-architecture-vision/architecture-vision.md` |
| BUS-CAT-01 | Business Service/Function Catalog | catalog | Business Architecture | reviewed | Business Architect | 1.0 | `02-business-architecture/catalogs/business-service-function-catalog.md` |
| BUS-MAT-01 | Business Interaction Matrix | matrix | Business Architecture | reviewed | Business Architect | 1.0 | `02-business-architecture/matrices/business-interaction-matrix.md` |
| BUS-DIA-01 | Order-to-Fulfillment Process Flow Diagram | diagram | Business Architecture | reviewed | Business Architect | 1.0 | `02-business-architecture/diagrams/order-to-fulfillment-process-flow-diagram.md` |
...
| GAP-01 | Gap Analysis - Baseline to Target Commerce Architecture | gap-analysis | Opportunities and Solutions | approved | Chief Architect | 1.0 | `06-opportunities-and-solutions/gap-analysis.md` |
| MIG-01 | Implementation and Migration Plan - Unified Commerce Platform | migration-plan | Migration Planning | approved | PMO | 1.0 | `07-migration-planning/implementation-and-migration-plan.md` |
| GOV-01 | Architecture Compliance Assessment - WP-02 Customer Profile Consolidation | compliance-assessment | Implementation Governance | approved | Architecture Review Board | 1.0 | `08-implementation-governance/architecture-compliance-assessment.md` |
| CHG-01 | Architecture Change Request - Custom Sync Adapter Waiver (PRIN-03) | change-request | Architecture Change Management | draft | Application Architect | 0.1 | `09-architecture-change-management/architecture-change-request.md` |
| REQ-CAT-01 | Requirements Catalog - Unified Commerce Platform | catalog | Requirements Management | approved | Chief Architect | 1.1 | `10-requirements-management/requirements-catalog.md` |
| VISION-MAT-01 | Stakeholder Map Matrix | matrix | Architecture Vision | approved | Chief Architect | 1.0 | `01-architecture-vision/stakeholder-map-matrix.md` |
| VISION-DIA-01 | Value Chain Diagram | diagram | Architecture Vision | approved | Chief Architect | 1.0 | `01-architecture-vision/value-chain-diagram.md` |
...
| BUS-CAT-03 | Process/Event/Control/Product Catalog | catalog | Business Architecture | reviewed | Business Architect | 1.1 | `02-business-architecture/catalogs/process-event-control-product-catalog.md` |
| DATA-DIA-03 | Data Security Diagram | diagram | Data Architecture | reviewed | Data Architect | 1.0 | `03-data-architecture/diagrams/data-security-diagram.md` |
| APP-MAT-03 | Application Interaction Matrix | matrix | Application Architecture | reviewed | Application Architect | 1.0 | `04-application-architecture/matrices/application-interaction-matrix.md` |
| BTRA-01 | Business Transformation Readiness Assessment - Unified Commerce Platform | readiness-assessment | Opportunities and Solutions | approved | Chief Architect | 1.0 | `06-opportunities-and-solutions/business-transformation-readiness-assessment.md` |
| TRANS-ARCH-01 | Transition Architecture - Unified Commerce Platform | transition-architecture | Migration Planning | approved | Chief Architect | 1.0 | `07-migration-planning/transition-architecture.md` |
| REQ-TRACE-01 | Requirements Traceability Matrix - Unified Commerce Platform | matrix | Requirements Management | reviewed | Chief Architect | 1.0 | `10-requirements-management/requirements-traceability-matrix.md` |
